package com.recykal.rtrends.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.recykal.rtrends.service.EmailAlreadyUsedException ||
            ex instanceof com.recykal.rtrends.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.recykal.rtrends.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.recykal.rtrends");
    }
}
